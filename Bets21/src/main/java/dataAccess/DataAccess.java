	...
	public void initializeDB(){
		...
		try {
		   ...
		   if (month==12) { month=0; year+=1;}  
			...
			Quote qo1 = q1.addQuote("quote1", 1.5);
			Quote qo2 = q1.addQuote("quote2", 2);
			Quote qo3 = q1.addQuote("quote3", 3);
			
			Quote qo4 = q2.addQuote("quote4", 1.5);
			Quote qo5 = q2.addQuote("quote5", 2);
			Quote qo6 = q2.addQuote("quote6", 3);
			
			
			Registered r1 = new Registered("r1","r1","Robert","87878787A", new Date(), "12421414", "a@a.com", 1250);
			Registered r2 = new Registered("r2","r2","Roberto","87878787B", new Date(), "12421414", "a@a.com", 420);
			Registered r3 = new Registered("r3","r3","Roberta","87878737B", new Date(), "12421414", "a@a.com", 850);

			month--;
			
			Movement m1 = r1.addMovement(1200, "Deposit: +" + 1200);
			m1.setDate(UtilDate.newDate(year,month,1));
			Movement m2 = r1.addMovement(1000, "Bet: -" + 1000+" on quotes: 15, 16, ");
			m2.setDate(UtilDate.newDate(year,month,1));
			Movement m3 = r1.addMovement(100, "Bet: -" + 100+" on quotes: 17, ");
			m3.setDate(UtilDate.newDate(year,month,1));
			Movement m4 = r1.addMovement(100, "Bet: -" + 100+" on quotes: 19, ");
			m4.setDate(UtilDate.newDate(year,month,2));
			Movement m5 = r1.addMovement(100, "Bet removed: +" + 100);
			m5.setDate(UtilDate.newDate(year,month,3));
			Movement m6 = r1.addMovement(1250, "Won bet: +" + 1250);
			m6.setDate(UtilDate.newDate(year,month,4));
			Movement m7 = r1.addMovement(0, "Lost bet");
			m7.setDate(UtilDate.newDate(year,month,5));
			Movement m30 = r1.addMovement(100, "Bet: -" + 100+" on quotes: 25, ");
			m30.setDate(UtilDate.newDate(year,month,6));
			Movement m31 = r1.addMovement(0, "Lost bet");
			m31.setDate(UtilDate.newDate(year,month,7));
			
			Movement m8 = r2.addMovement(500, "Deposit: +" + 500);
			m8.setDate(UtilDate.newDate(year,month,1));
			Movement m9 = r2.addMovement(200, "Bet: -" + 200+" on quotes: 18, ");
			m9.setDate(UtilDate.newDate(year,month,3));
			Movement m10 = r2.addMovement(400, "Won bet: +" + 400);
			m10.setDate(UtilDate.newDate(year,month,4));
			Movement m11 = r2.addMovement(100, "Bet: -" + 100+" on quotes: 21, 23, ");
			m11.setDate(UtilDate.newDate(year,month,5));
			Movement m12 = r2.addMovement(100, "Bet removed: +" + 100);
			m12.setDate(UtilDate.newDate(year,month,6));
			Movement m13 = r2.addMovement(300, "Bet: -" + 300+" on quotes: 24, ");
			m13.setDate(UtilDate.newDate(year,month,7));
			Movement m14 = r2.addMovement(100, "Bet: -" + 100+" on quotes: 27, ");
			m14.setDate(UtilDate.newDate(year,month,7));
			Movement m15 = r2.addMovement(100, "Bet: -" + 100+" on quotes: 26, 29, ");
			m15.setDate(UtilDate.newDate(year,month,7));
			Movement m16 = r2.addMovement(110, "Won bet: +" + 110);
			m16.setDate(UtilDate.newDate(year,month,7));
			Movement m17 = r2.addMovement(110, "Won bet: +" + 110);
			m17.setDate(UtilDate.newDate(year,month,7));
			Movement m18 = r2.addMovement(0, "Lost bet");
			m18.setDate(UtilDate.newDate(year,month,9));
			
			Movement m19 = r3.addMovement(700, "Deposit: +" + 700);
			m19.setDate(UtilDate.newDate(year,month,3));
			Movement m20 = r3.addMovement(300, "Bet: -" + 300+" on quotes: 30, ");
			m20.setDate(UtilDate.newDate(year,month,3));
			Movement m21 = r3.addMovement(300, "Bet: -" + 300+" on quotes: 31, 33, ");
			m21.setDate(UtilDate.newDate(year,month,4));
			Movement m22 = r3.addMovement(500, "Won bet: +" + 500);
			m22.setDate(UtilDate.newDate(year,month,4));
			Movement m23 = r3.addMovement(100, "Bet: -" + 100+" on quotes: 28, ");
			m23.setDate(UtilDate.newDate(year,month,5));
			Movement m24 = r3.addMovement(0, "Lost bet");
			m24.setDate(UtilDate.newDate(year,month,5));
			Movement m25 = r3.addMovement(300, "Won bet: +" + 300);
			m25.setDate(UtilDate.newDate(year,month,6));
			Movement m26 = r3.addMovement(500, "Bet: -" + 500+" on quotes: 34, ");
			m26.setDate(UtilDate.newDate(year,month,7));
			Movement m27 = r3.addMovement(600, "Won bet: +" + 600);
			m27.setDate(UtilDate.newDate(year,month,8));
			Movement m28 = r3.addMovement(50, "Bet: -" + 50+" on quotes: 35, 36, 37, ");
			m28.setDate(UtilDate.newDate(year,month,8));
			Movement m29 = r3.addMovement(0, "Lost bet");
			m29.setDate(UtilDate.newDate(year,month,9));
...
public void open(boolean initializeMode){
	...
	public Vector<Message> allRecivedMessages(String username) {
		...
		if (user  instanceof Admin) {
			...
			list = admin.getRecivedMessages();
		}else {
			users = db.find(Registered.class, username);
			list = users.getRecivedMessages();
		}
		*/
		return list;
	...
	public Vector<Message> allSentMessages(String username) {
		...
		if (user  instanceof Admin) {
			admin = db.find(Admin.class, username);
			list = admin.getSentMessages();
		}else {
			users = db.find(Registered.class, username);
			list = users.getSentMessages();
		}
		*/
		return list;
	}
